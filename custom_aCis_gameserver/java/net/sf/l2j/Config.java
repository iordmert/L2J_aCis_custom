...
public final class Config
{
	...
	public static boolean ALLOW_CHAR_TITLE;
	public static String CHAR_ADD_TITLE;
	...
	public static int HERO_CUSTOM_HOURS;
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			//Custom settings
			ExProperties custom = load(CUSTOM);
			ALLOW_CREATE_LVL = custom.getProperty("CustomStartingLvl", false);
			CHAR_CREATE_LVL = custom.getProperty("CharLvl", 0);
			ALLOW_CHAR_TITLE = custom.getProperty("CharTitle", false);
			CHAR_ADD_TITLE = custom.getProperty("CharAddTitle", "");
			...
			ONLINE_PLAYERS_ON_LOGIN = Boolean.valueOf(custom.getProperty("OnlineOnLogin", "False"));

			WELCOME_HTM = Boolean.parseBoolean(custom.getProperty("WelcomeHtm", "False"));
			
			PM_MESSAGE_ON_START = Boolean.parseBoolean(custom.getProperty("PMWelcomeShow", "False"));
			PM_SERVER_NAME = custom.getProperty("PMServerName", "L2-Frozen");
			PM_TEXT1 = custom.getProperty("PMText1", "Have Fun and Nice Stay on");
			PM_TEXT2 = custom.getProperty("PMText2", "Vote for us every 24h");
			
			NEW_PLAYER_EFFECT = Boolean.parseBoolean(custom.getProperty("NewPlayerEffect", "True"));
			
			ANNOUNCE_PVP_KILL = Boolean.parseBoolean(custom.getProperty("AnnouncePvPKill", "False"));
			ANNOUNCE_PK_KILL = Boolean.parseBoolean(custom.getProperty("AnnouncePkKill", "False"));
			
			NOBLE_CUSTOM_ITEMS = Boolean.parseBoolean(custom.getProperty("EnableNobleCustomItem", "true"));
			
			HERO_CUSTOM_ITEMS = Boolean.parseBoolean(custom.getProperty("EnableHeroCustomItem", "true"));
			HERO_CUSTOM_HOURS = Integer.parseInt(custom.getProperty("HeroCustomHours", "0"));

			// pvp
			PVP_COLOR_SYSTEM_ENABLED = Boolean.parseBoolean(custom.getProperty("EnablePvPColorSystem", "false"));
			PVP_AMOUNT1 = Integer.parseInt(custom.getProperty("PvpAmount1", "500"));
			PVP_AMOUNT2 = Integer.parseInt(custom.getProperty("PvpAmount2", "1000"));
			PVP_AMOUNT3 = Integer.parseInt(custom.getProperty("PvpAmount3", "1500"));
			PVP_AMOUNT4 = Integer.parseInt(custom.getProperty("PvpAmount4", "2500"));
			PVP_AMOUNT5 = Integer.parseInt(custom.getProperty("PvpAmount5", "5000"));
			NAME_COLOR_FOR_PVP_AMOUNT1 = Integer.decode("0x" + custom.getProperty("ColorForAmount1", "00FF00"));
			NAME_COLOR_FOR_PVP_AMOUNT2 = Integer.decode("0x" + custom.getProperty("ColorForAmount2", "00FF00"));
			NAME_COLOR_FOR_PVP_AMOUNT3 = Integer.decode("0x" + custom.getProperty("ColorForAmount3", "00FF00"));
			NAME_COLOR_FOR_PVP_AMOUNT4 = Integer.decode("0x" + custom.getProperty("ColorForAmount4", "00FF00"));
			NAME_COLOR_FOR_PVP_AMOUNT5 = Integer.decode("0x" + custom.getProperty("ColorForAmount5", "00FF00"));
