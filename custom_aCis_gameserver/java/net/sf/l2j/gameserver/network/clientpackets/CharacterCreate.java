...
public final class CharacterCreate extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.ALLOW_CREATE_LVL)
			newChar.getStat().setLevel((byte)Config.CHAR_CREATE_LVL);
		
		if (Config.ALLOW_CHAR_TITLE)
			newChar.setTitle(Config.CHAR_ADD_TITLE);
		...
		else newChar.setXYZInvisible(template.getSpawnX(), template.getSpawnY(), template.getSpawnZ());
