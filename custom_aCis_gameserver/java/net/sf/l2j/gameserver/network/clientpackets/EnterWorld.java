...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (Config.PM_MESSAGE_ON_START)
		{
			...
			activeChar.sendPacket(new CreatureSay(15, Say2.PARTYROOM_COMMANDER, activeChar.getName(), Config.PM_TEXT1));
		...
		if (Config.NEW_PLAYER_EFFECT)
		{
			...
			if (skill != null)
			{
				final MagicSkillUse magic = new MagicSkillUse(activeChar, activeChar, 2025, 1, 1, 0);
				activeChar.sendPacket(magic);
				activeChar.broadcastPacket(magic);
